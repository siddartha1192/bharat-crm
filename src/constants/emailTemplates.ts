 ...
 * These are used as reference templates when creating new email templates
 */
...
<body>
  <div class="container">
    ...
    <div class="content">
      <p>Hi there,</p>
      <p>This is a custom email template. You can customize this to fit your needs.</p>
 ...
 */
export function getDefaultTemplateByType(type: string): DefaultTemplate | undefined {
  return DEFAULT_EMAIL_TEMPLATES.find(template => template.type === type);
}
